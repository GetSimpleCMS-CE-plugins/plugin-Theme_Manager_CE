...
//Application Title
define('APP_TITLE', 'Theme Manager CE');
...
$exclude_items = array('admin','backups','data','plugins','sitemap.xml','robots.txt','filemanager');
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="btn-group btn-group-sm flex-wrap" role="group">
                ...
                <?php endif; ?>
                <a class="fw-bold btn btn-outline-primary" href="<?php echo  str_replace(str_replace('\\','/',GSTHEMESPATH),$SITEURL.'theme/',fm_enc($file_path)) ; ?>" target="_blank"><i class="fa fa-external-link-square"></i> <?php echo lng('Open') ?></a></b>
                <?php
                // ZIP actions
            ...
            <div class="row mt-3">
                ...
                if ($is_onlineViewer) {
                    ...
                    if (in_array($ext, array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) {
                        echo '<p><input type="checkbox" id="preview-img-zoomCheck"><label for="preview-img-zoomCheck"><img src="' . str_replace(str_replace('\\','/',GSTHEMESPATH),$SITEURL.'theme/',fm_enc($file_path)) . '" alt="image" class="preview-img"></label></p>';
                    }
                } elseif ($is_audio) {
                    // Audio content
